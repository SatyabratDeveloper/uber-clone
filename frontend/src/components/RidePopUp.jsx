      ...
      <div className="flex flex-col items-center justify-between gap-2">
        ...
        <div className="w-full mt-5 ">
          <button
            ...
            className="w-full p-2 px-10 font-semibold text-white bg-green-600 rounded-lg "
          >
            Accept
          </button>
          ...
          <button
            ...
            className="w-full p-2 px-10 mt-2 font-semibold text-gray-700 bg-gray-300 rounded-lg"
          >
            Ignore
          </button>
        </div>
